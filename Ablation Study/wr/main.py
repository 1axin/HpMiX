...
from utils import load_data_from_csv_Randn
...
if __name__ == "__main__":
    ...
    hg_1hop, hg_3hop, num_nodes, node_mapping, reverse_mapping, train_edge_indices, train_edge_labels, val_edge_indices, val_edge_labels, x = load_data_from_csv_Randn(
        csv_file)
    in_channels = 32
    hidden_channels = 128
    out_channels = 2
